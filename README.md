...
**[Latest release — v1.0.5](https://github.com/ab2024103-cmd/Morsecode/releases/tag/v1.0.5)**

| Platform | File | Size |
|---|---|---|
| Windows 10/11 | `MorseCode_1.0.5_x64-setup.exe` · `MorseCode_1.0.5_x64_en-US.msi` | 3.0 MiB · 4.0 MiB |
| Windows, **offline PC** | `MorseCode_1.0.5_x64-setup-offline-webview2.exe` (bundles the WebView2 runtime) | 208.9 MiB |
| macOS (Apple silicon) | `MorseCode_1.0.5_aarch64.dmg` | 3.5 MiB |
| macOS (Intel) | `MorseCode_1.0.5_x64.dmg` | 3.6 MiB |
| Linux | `MorseCode_1.0.5_amd64.deb` · `MorseCode_1.0.5_amd64.AppImage` | 4.1 MiB · 78.8 MiB |
...
That is a startup failure in a GUI-subsystem binary, which by design has no console to print to. Since **v1.0.5** MorseCode writes every startup stage to a log and shows a native error dialog instead of vanishing:
...
```
boot     MorseCode 1.0.5 · windows x86_64 · exe "C:\Program Files\MorseCode\MorseCode.exe"
...
```bash
git tag -a v1.0.5 -m "MorseCode v1.0.5" && git push origin v1.0.5
```
